...
export const testimonials = [
  ...
  // Radiestesia Genética
  {
    ...
    verified: true,
    avatar: 'SG',
    testimonial: 'Eu tinha dores que profissionais da saúde não explicavam. A Radiestesia mostrou que era algo herdado da minha avó. Depois da sessão, senti alívio real.',
  ...
  },
  {
    ...
    verified: true,
    avatar: 'EM',
    testimonial: 'Como terapeuta holístico, sou cético por natureza. Mas os resultados foram inegáveis. Minha ansiedade diminuiu consideravelmente após o tratamento.',
  ...
  },
  {
    ...
    verified: true,
    avatar: 'RA',
    testimonial: 'A gente brigava todo dia. Eu achava que era culpa dele, mas entendi que a reequilíbrio começava por mim. Hoje somos parceiros.',
