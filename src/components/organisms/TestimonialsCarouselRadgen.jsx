...
const TestimonialsCarouselRadgen = ({ testimonials }) => {
  const renderTestimonial = (testimonial, index) => (
    ...
    >
      <Card className="h-full border-amber-200/80 shadow-md p-6 flex flex-col bg-white hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="text-right border-t border-amber-100 pt-4">
  ...
  return (
    <section className="py-20 md:py-24 bg-gradient-to-br from-amber-50 to-yellow-50/30">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Veja os resultados reais de quem já passou pela Radiestesia Genética
          </motion.p>
        </div>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-slate-600">Análises Genéticas</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-amber-600 mb-2">98%</div>
            <div className="text-slate-600">Taxa de Precisão</div>
          </div>
          <div className="text-center">
...
export default TestimonialsCarouselRadgen;
