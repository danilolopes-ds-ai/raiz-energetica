...
const HeroRadiestesia = React.lazy(() => import('./landing-components/HeroRadiestesia'));
const ProvaCientifica = React.lazy(() => import('./landing-components/ProvaCientifica'));
const SintomasRadgen = React.lazy(() => import('./landing-components/SintomasRadgen'));
const OqueEradgen = React.lazy(() => import('./landing-components/OqueEradgen'));
const ComoAgeRadgen = React.lazy(() => import('./landing-components/ComoAgeRadgen'));
const ParaQuemEradgen = React.lazy(() => import('./landing-components/ParaQuemEradgen'));
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center bg-slate-100 p-10 rounded-2xl max-w-3xl mx-auto border border-slate-200">
              ...
              <Button 
                onClick={handleBookingClick} 
                size="lg" 
                className="mt-4 xs:mt-6 sm:mt-8 w-full sm:w-auto bg-amber-600 hover:bg-amber-700 text-white font-bold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 py-3 xs:py-4 h-auto animate-pulse"
