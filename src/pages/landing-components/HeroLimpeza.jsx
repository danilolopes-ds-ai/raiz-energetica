      ...
      <div className="container mx-auto px-6 lg:px-8 py-20 md:py-28 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Button asChild size="lg" className="bg-teal-600 hover:bg-teal-700 text-white font-bold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                <a href="#oferta">Quero Renovar Minha Energia</a>
              </Button>
